# File name: 15_final_graph_adult_mu_1.py
...
# create a bar graph of mu1's compared between cell types. Higher
# values of mu1 indicates more protein per mRNA by fold change overall.
...
def main():
	# Starting message
	print('Starting [15_final_graph_mRNA_mu_1]\n'); flush()
	...
	ax.bar(cell_order, data[:, 0], color = color_list)
	plt.savefig(analysis_dir + 'adult/mRNA/15_mRNA_mu_1')
	plt.close(fig)

	# Closing message
	print('\n[15_final_graph_mRNA_mu_1] complete')
